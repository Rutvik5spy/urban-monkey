...
export default function About(){
    ...
    <div>
         <h1 className="about1">VISION :-</h1>
         <img src={img1} alt="abc" width="600px" className="about3" />
     </div>

     <div >
         <h1 className="about2">TIMELINE :-</h1>
         <p className="about4">What started in 2013, with a simple goal of increasing awareness about the skate culture in Mumbai,<br/> has now evolved into a deep rooted 
